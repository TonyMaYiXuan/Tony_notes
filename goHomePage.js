...
function goHomePage(flag) { //1 for returning home and 0 for leaving home page
    ...
    if (flag) {
        ...
        document.getElementById('menuTable').innerHTML = '<tr><td align=\'center\'><div id=\'menuTableHome\' cellspacing=0 cellpadding=0 onclick=\'menuTableHomeClicked();\'>START</div></td></tr>';
