...
function goHomePage(flag) { //1 for returning home and 0 for leaving home page
    ...
    if (flag) {
        ...
        document.getElementById('menuTable').innerHTML = '<tr><td align=\'center\'><div id=\'menuTableStart\' onclick=\'menuTableStartClicked();\'>START</div></td></tr>';  // menuTableStart used in dayNightMode.js
