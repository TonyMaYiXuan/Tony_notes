function dayNightMode(flag) {
    ...
    if ((typeof document.getElementById('mainDisplay').contentWindow.dataDict != 'undefined') && (document.getElementById('mainDisplay').contentWindow.dataDict.src == 'description/index.html')) {
